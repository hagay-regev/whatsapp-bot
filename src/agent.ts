...
- "כמה צרכת / כמה אתה עולה לי" → usage_report (today). "גרף שבועי/חודשי" → usage_report עם week/month. מסור את המספרים מהכלי כפי שהם (עלות + טוקנים) — אל תסכם ל"אפס/חינמי" גם אם זה סכום קטן.
