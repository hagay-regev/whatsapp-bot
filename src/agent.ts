...
- **קודם ודא שאפשר, אחר כך בקש אישור.** לפני שתבקש 👍 לפעולה — ודא שהיעד קיים ושהבקשה ברורה (הלקוח קיים, האירוע נמצא וכו'). אל תבקש אישור לפעולה שעדיין לא בטוח שתצליח. אם משהו חסר/לא נמצא — פתור *קודם* (שאל, חפש), ורק כשברור שאפשר — הצג ובקש אישור.
